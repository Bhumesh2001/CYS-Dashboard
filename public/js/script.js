...
const baseUrl = 'https://cys-dashboard.vercel.app';
let totalPages = 3;
        ...
        new Chart(ctxUserAnalytics, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [30, 50, 70, 60, 90, 120, 140, 110, 130, 100, 150, 170],
            ...
            options: {
                ...
                scales: {
                    x: { title: { display: true, text: "Months", color: "#666" } },
                    y: {
                        beginAtZero: true,
                        title: { display: true, text: "Users", color: "#666" },
                        ticks: { stepSize: 20 },
                    },
                },
            }
...
async function submitData(event, id, loderId, btnId) {
    ...
    // file links
    const fileLinks = {
        "Create Class": `/admin/class`,
        "Create Subject": `/admin/subject`,
        "Create Chapter": `/admin/chapter`,
        "Create Question": `/admin/question`,
        "Create Quiz": `/admin/quiz`,
        "Create User": `/admin/user`,
        "Create Admin": `/admin/admin_`,
        "Update General Setting": `/admin/setting1`,
        "Update SMTP Setting": `/admin/setting1`,
        "Update App General Setting": `/admin/setting2`,
        "Update App Setting": `/admin/setting2`,
        "Update Privacy Policy": `/admin/setting2`,
        "Update Terms Setting": `/admin/setting2`,
        "Update Notification Setting": `/admin/setting2`,
        "Update App Update Setting": `/admin/setting2`,
    };
        ...
        deleteData(`${baseUrl}${data_url}`, token, data_id)
            .then(response => {
                if (response) {
                    ...
                    setTimeout(() => {
                        window.location.href = `/admin/${data_link}`;
                    }, 100);
                };
            })
            .catch(error => {
...
if (handleMissingElement('#editBtn')) {
    ...
    document.getElementById('editBtn').addEventListener('click', async (event) => {
        ...
        // file links
        const fileLinks = {
            "Edit Class": `/admin/class`,
            "Edit Subject": `/admin/subject`,
            "Edit Chapter": `/admin/chapter`,
            "Edit Question": `/admin/question`,
            "Edit Quiz": `/admin/quiz`,
            "Edit User": `/admin/user`,
            "Edit Admin": `/admin/admin_`,
        };
